    ...
    try {
      ...
      if (hasEditableFields) {
        item.updateInfo({
          ...
          type: req.body.type !== undefined ? (req.body.type as TransactionType) : undefined,
          ...
          frequency: req.body.frequency !== undefined ? (req.body.frequency as RecurringFrequency) : undefined,
